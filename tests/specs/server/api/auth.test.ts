...
describe("auth", () => {
	...
	it("rejects /api/scraps with a bogus cookie of the right length", async () => {
	...
	it("POST /api/auth/login with the right password sets the cookie", async () => {
	...
	it("GET /api/auth/check returns 200 when authed, 401 when not", async () => {
